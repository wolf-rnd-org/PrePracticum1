...
{
    public class SubtitleTranslationCommand : BaseCommand,ICommand<SubtitleTranslationModel>
    {
        ...
        public async Task<CommandResult> ExecuteAsync(SubtitleTranslationModel model)
        {
